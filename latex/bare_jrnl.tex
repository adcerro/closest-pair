...
% The paper headers
\markboth{Uninorte, Octubre~2022}%
...
\input{sections/mejoras.tex}
\input{sections/conclucion.tex}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{images/alan.jpg}}]{Alan Florez}
